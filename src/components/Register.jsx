                    ...
                    {({ setFieldValue, errors, touched }) => (
                        ...
                        <Form className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div className="w-full md:col-span-2">
                                <button type="submit" disabled={loading} className={`w-full bg-[#6667DD] text-white py-2.5 sm:py-3 rounded-lg transition duration-300 mt-2 p-regular cursor-pointer text-sm sm:text-base ${loading ? "opacity-70 cursor-not-allowed" : "hover:bg-[#5556cc]"}`}>
