        ...
        <div className="relative flex items-center justify-center min-h-screen overflow-hidden px-4 sm:px-6 lg:px-8">
            ...
            <div className="w-full max-w-md sm:max-w-lg bg-[#F6F9FC] py-10 px-4 sm:p-8 rounded-xl shadow-md relative z-10">
                ...
                <h1 className="text-[#6667DD] text-2xl sm:text-3xl p-bold mb-6 text-center">
                    {passwordReset ? "Password Reset Successful" : "Reset Password"}
                </h1>
                            ...
                            {({ values, handleChange, errors, touched }) => (
                                <Form className="flex flex-col gap-4">
                                    <div className="flex flex-col relative">
                                        <label className="text-gray-700 p-medium mb-1">New Password</label>
                                        <Field
                                    ...
                                    <div className="flex flex-col relative">
                                        <label className="text-gray-700 p-medium mb-1">Confirm New Password</label>
                                        <Field
                                            ...
                                            className={`w-full px-3 py-2 rounded-lg outline-none p-regular text-sm sm:text-base pr-10
                                                border
                                                ${errors.confirmPassword && touched.confirmPassword ? 'border-red-500' : 'border-[#6667DD]'}`}
                                        />
                                        {errors.confirmPassword && touched.confirmPassword && (
                                            <div className="text-red-500 text-sm mt-1 transition-opacity duration-300 opacity-100">{errors.confirmPassword}</div>
                                        )}
                                        <div
                                            className="absolute right-3 top-[38px] cursor-pointer text-gray-600 hover:text-[#6667DD] transition"
