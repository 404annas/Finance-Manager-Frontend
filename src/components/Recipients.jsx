...
import UsersInRecipients from "./UsersInRecipients";
...
const Recipients = () => {
    ...
    return (
        ...
        //             className="flex items-center gap-2 bg-gradient-to-r from-[#6667DD] to-[#7C81F8] text-white px-5 py-3 rounded-full shadow-sm hover:scale-97 transition-all duration-300 p-regular cursor-pointer w-full sm:w-auto justify-center"
        //         >
