        ...
        <div className="mb-8 p-4 bg-purple-50 border border-purple-200 rounded-xl shadow-sm">
            ...
            <div className="space-y-3">
                {pendingRequests.map((req) => (
                    <div
                        key={req._id}
                        className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3 bg-white rounded-lg shadow-sm"
                    >
                        <div className="flex items-center gap-3">
                            <img
                                src={req.requester.profileImage || "https://via.placeholder.com/40"}
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-2 text-sm bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors duration-200 p-medium disabled:bg-green-300 disabled:cursor-not-allowed"
                        >
                            <Check size={16} />
