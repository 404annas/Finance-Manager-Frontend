...
const Contact = () => {
    ...
    return (
        <div className="flex justify-center items-start sm:items-center px-2 sm:px-4 md:px-6 lg:px-8 py-6">
            <div className="bg-[#F6F9FC] rounded-3xl shadow-sm p-4 sm:p-6 md:p-8 w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-3xl">
