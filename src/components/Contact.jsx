...
const Contact = () => {
    ...
    return (
        <div className="flex items-center justify-center">
            <div className="bg-[#F6F9FC] rounded-3xl shadow-sm p-6 w-full max-w-4xl">
                <h2 className="text-2xl p-semibold text-[#6667DD] mb-2 text-center">
                    Contact Us
                </h2>
                <p className="text-gray-600 text-center mb-6 text-sm p-regular">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-3">
                        <div className="flex-1 flex items-center border-2 border-[#6667DD] rounded-lg px-3 py-2">
                            ...
                            <input
                                ...
                                className="w-full outline-none p-regular"
                                required
                            />
                        </div>
                        <div className="flex-1 flex items-center border-2 border-[#6667DD] rounded-lg px-3 py-2">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            value={formData.type}
                            onChange={handleChange}
                            className="w-full border-2 border-[#6667DD] cursor-pointer rounded-lg px-3 py-2 outline-none p-regular"
                        >
                    ...
                    {/* Message Box */}
                    <div className="flex items-start border-2 border-[#6667DD] rounded-lg px-3 py-2">
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            className="w-full outline-none p-regular resize-none"
                            required
                        />
                    </div>
